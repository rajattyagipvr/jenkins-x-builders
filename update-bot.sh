...
jx step create pr chart --name 702769831180.dkr.ecr.ap-south-1.amazonaws.com/702769831180/builder-ruby --name 702769831180.dkr.ecr.ap-south-1.amazonaws.com/702769831180/builder-swift \
  ...
  --version ${VERSION} --repo https://github.com/rajattyagipvr/jenkins-x-platform.git
...
jx step create pr regex --regex "(?m)^\s+repository: 702769831180.dkr.ecr.ap-south-1.amazonaws.com/702769831180/builder-[\w-_]+\s+tag: (?P<version>.*)$" --version ${VERSION} --files jenkins-x-platform/values.yaml --files values.yaml --repo https://github.com/rajattyagipvr/jenkins-x-platform.git
jx step create pr regex --regex "(?m)^\s+repository: 702769831180.dkr.ecr.ap-south-1.amazonaws.com/702769831180/builder-maven\s+tag: (?P<version>.*)" --version ${VERSION} --files prow/values.yaml --files environment-controller/values.yaml --repo https://github.com/rajattyagipvr-charts/prow.git --repo https://github.com/rajattyagipvr-charts/environment-controller.git
jx step create pr regex --regex "(?m)^\s+repository: 702769831180.dkr.ecr.ap-south-1.amazonaws.com/702769831180/builder-[\w-_]+\s+tag: (?P<version>.*)$" --version ${VERSION} --files jxboot-helmfile-resources/values.yaml --repo https://github.com/rajattyagipvr-charts/jxboot-helmfile-resources.git
jx step create pr regex --regex "(?m)^\s+image: 702769831180.dkr.ecr.ap-south-1.amazonaws.com/702769831180/builder-[\w-_]+:(?P<version>.*)$" --version ${VERSION} --files jxboot-helmfile-resources/values.yaml --repo https://github.com/rajattyagipvr-charts/jxboot-helmfile-resources.git
...
# jx step create pr regex --regex "\s*jxTag:\s*(.*)" --version $JX_VERSION --files prow/values.yaml --repo https://github.com/rajattyagipvr-charts/prow.git --src-repo https://github.com/rajattyagipvr/jx.git
